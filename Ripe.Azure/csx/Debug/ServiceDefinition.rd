...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Ripe.Azure" generation="1" functional="0" release="0" Id="acfc77c4-199b-426a-86d0-cbe3079c717d" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="Ripe.AzureGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="Ripe" generation="1" functional="0" release="0" software="C:\Users\Ethan\Documents\Visual Studio 2013\Projects\Ripe\Ripe.Azure\csx\Debug\roles\Ripe" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="1792" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="3c21dac8-8281-4a68-9d52-83242704c092" ref="Microsoft.RedDog.Contract\ServiceContract\Ripe.AzureContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="2cd1d0ef-b352-49b2-a382-7191ff391381" ref="Microsoft.RedDog.Contract\Interface\Ripe:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Ripe.Azure/Ripe.AzureGroup/Ripe:Endpoint1" />
          </inPort>
        </interfaceReference>
